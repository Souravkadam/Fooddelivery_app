...
const Menubar = () => {
  ...
  <div className="container">
   <Link to="/"><img src={assets.logo} alt="" className='mx-2' height={48} width={67}/></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="d-flex align-item-center">
        ...
        </Link>
        {
          !token ?(
           <>
           <button className='btn btn-outline-primary me-2 btn-sm' onClick={()=> navigate('./login')}>Login</button>
        <button className='btn btn-outline-success btn-sm' onClick={()=> navigate('./register')}>Register</button>
        </>)  : (<div className="dropdown text-end">
          
            <a href="" className="d-black link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
